...
public class MongoClientLesson extends AbstractLesson {
  ...
  private String uri = "mongodb+srv://m220student:m220password@mflix-r9uwl.mongodb.net/test?maxPoolSize=50";
  ...
  public void MongoDatabaseInstance() {
    ...
    /*
    Here, because we did not specify a Read Preference, the driver will
